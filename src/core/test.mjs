...
describe('Tree', () => {
  ...
  it('merge', () => {
    ...
    expect(tree300303.collect()).toEqual([3, 3, 3]);
  });
  ...
  it('split', () => {
    ...
    expect(tree.collect()).toEqual([1, 2, 0, 3, 4, 0]);

    tmp = tree.split(0, 0);
    expect(tmp.left.collect()).toEqual([]);
    expect(tmp.middle.collect()).toEqual([]);
    expect(tmp.right.collect()).toEqual([1, 2, 0, 3, 4, 0]);

    tmp = tree.split(0, 3);
    expect(tmp.left.collect()).toEqual([]);
    expect(tmp.middle.collect()).toEqual([1]);
    expect(tmp.right.collect()).toEqual([2, 0, 3, 4, 0]);

    tmp = tree.split(2, 5);
    expect(tmp.left.collect()).toEqual([]);
    expect(tmp.middle.collect()).toEqual([1, 2, 0, 3]);
    expect(tmp.right.collect()).toEqual([4, 0]);

    tmp = tree.split(3, 8);
    expect(tmp.left.collect()).toEqual([1, 2, 0]);
    expect(tmp.middle.collect()).toEqual([3]);
    expect(tmp.right.collect()).toEqual([4, 0]);
    ...
    tmp = tree.split(3, 9);
    expect(tmp.left.collect()).toEqual([1, 2, 0]);
    expect(tmp.middle.collect()).toEqual([3, 4]);
    expect(tmp.right.collect()).toEqual([0]);

    tmp = tree.split(12, 15);
    expect(tmp.left.collect()).toEqual([1, 2, 0, 3, 4, 0]);
    expect(tmp.middle.collect()).toEqual([]);
